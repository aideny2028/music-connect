  ...
  return (
    <div className="min-h-screen bg-transparent">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <Link href="/dashboard/marketplace" className="inline-flex items-center gap-1.5 text-sm text-white/70 hover:text-white mb-6 transition-colors">
          <ArrowLeft className="h-4 w-4" /> My Instruments
        </Link>
        <div className="glass rounded-xl border border-white/20 p-6">
          <h1 className="text-2xl font-bold text-white mb-6">List an Instrument</h1>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Link href="/dashboard/marketplace" className={cn(buttonVariants({ variant: 'outline' }))}>
                Cancel
              </Link>
            </div>
          </form>
